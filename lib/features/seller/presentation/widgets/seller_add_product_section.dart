...
class SellerAddProductSection extends StatefulWidget {
  const SellerAddProductSection({super.key});

  @override
  State<SellerAddProductSection> createState() =>
      _SellerAddProductSectionState();
}

class _SellerAddProductSectionState extends State<SellerAddProductSection> {
  ...
  void initState() {
    super.initState();
    _selectedCategory = ProductTaxonomy.defaultCategory();
    _selectedSubcategory =
        ProductTaxonomy.defaultSubcategoryFor(_selectedCategory);
    _loadProducts();
  }
  ...
  Widget _buildAddProductCard() {
    final subcategories = ProductTaxonomy.subcategoriesFor(_selectedCategory);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Create your gadget listing with category, subcategory, and tags.',
            ...
            DropdownButtonFormField<String>(
              ...
              items: ProductTaxonomy.categoryList.map((category) {
              ...
              onChanged: (value) {
                ...
                final nextSubcategories =
                    ProductTaxonomy.subcategoriesFor(value);

                setState(() {
                  _selectedCategory = value;
                  _selectedSubcategory = nextSubcategories.first;
                });
              },
            ),
            const SizedBox(height: 14),
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Tags',
                hintText: 'Example: wireless, gaming, rgb, type-c',
              ),
            ),
          ...
          children: [
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final tags = List<String>.from(product['tags'] ?? const []);
